...
for(var i=0; i<testElements.length;i++){
 ...
 var pis4= cadenamaster1.indexOf("F");
  ...
  console.log("holi"+numeral);
  console.log("holi"+numeral1);
...
for(var i=0; i<longitud;i++){
  ...
  if(debug == true && verLongitud == true){
    ...
    var txt2 = ""
    var txt = ""
    txt = "&nbsp;<sub>" + palabraspro[i][1].length+ "</sub>";
    txt2 = "&nbsp;<sup>" + palabraspro[i][0]+ "</sup> &nbsp;&nbsp;";
    inputsecu.setAttribute('value',palabraspro[i][1] + txt2 + txt);
  }else if(debug){
